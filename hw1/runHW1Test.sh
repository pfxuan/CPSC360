...
echo -e "----------------------------------"
echo -e "Note: the total score in this test script is only used to check incompatible implementation, and does not have a direct connection with your final HW#1 grade received from TA. We'll use different testing values and extra testing cases to further inspect your final submission."
